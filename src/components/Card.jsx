...
//     console.log(username) this btnText is initilized here because agar koi value nahi mila in the app.js in the props assigment it will get assihed to the default value passed here which is visit me
function card({username,btnText="visit me"}){
